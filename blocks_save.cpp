...
bool user_wants_to_do_something = false;
void command( int cmd )
{
  switch ( cmd )
    ...
    case ' ':
      ...
      break;
    case 'c':
      user_wants_to_do_something = true;
    default:
...
void simLoop( int pause )
{
  ...
  //If cmd flag get string from command, write to file from python file, add to state
  /*if ( user_wants_to_do_something)
    //my_create_stuff( s );*/
